...
describe('getPlayerRank for 3players', () => {
  ...
  test('should return a playerA result', () => {
    ...
    expect(
      rankService
        .getPlayerRank(playerA, dateRange, fixtureValue.mode3players)
        .get(playerA),
    ).toEqual(expected)
  })
  test('should return a playerB result', () => {
    ...
    expect(
      rankService
        .getPlayerRank(playerB, dateRange, fixtureValue.mode3players)
        .get(playerB),
    ).toEqual(expected)
  })
  test('should return a playerC result', () => {
    ...
    expect(
      rankService
        .getPlayerRank(playerC, dateRange, fixtureValue.mode3players)
        .get(playerC),
    ).toEqual(expected)
  })
})
...
describe('getPlayerRank for 4players', () => {
  ...
  const playerC = new Player('3', 'playerC', new ScoreList([scores5, scores6]))
  const scores7 = new Score(
    fixtureValue.fixDate,
    new Point(20),
    fixtureValue.mode3players,
  )
  const scores8 = new Score(
    fixtureValue.oneSecLaterDate,
    new Point(-20),
    fixtureValue.mode3players,
  )
  ...
  test('should return a playerD result', () => {
    ...
    expect(
      rankService
        .getPlayerRank(playerD, dateRange, fixtureValue.mode3players)
        .get(playerD),
    ).toEqual(expected)
  })
})
